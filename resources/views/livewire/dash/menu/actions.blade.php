<div class="flex items-center space-x-1">
    <a href="{{ route('dash.edit', ['item' => 'menu', 'id' => $data->id]) }}" title="Edit"
        class="group p-2 border border-transparent rounded-full text-white hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400">
