            ...
            <form wire:submit.prevent="store">
                <div class="px-4 py-5 sm:p-6 md:grid md:grid-cols-3 md:gap-6">
                    <div class="md:col-span-1">
                        <h3 class="text-lg font-medium leading-6 text-gray-900">Create Submenu</h3>
                    </div>
                    <div class="mt-5 md:mt-0 md:col-span-2">
                        <div class="space-y-6">
                            <span class="uppercase font-bold">Menu: {{ $menu_name }}</span>
                            <x-input label="Nama Submenu" wire:model="sub_name" name="sub_name" livewire />
                            <x-input label="Url" wire:model="sub_url" name="sub_url"
                                placeholder="https://nfbs.or.id/link-post-ini" livewire />
                        </div>
                    </div>
                </div>
